  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        status: 1,
        type: 'menu',
        authCode: 'system:audit:login:list',
        meta: {
        ...
        children: [
          ...
          },
          {
            id: 20_502,
            pid: 204,
            name: 'SystemAuditOperationList',
            status: 1,
            type: 'button',
            authCode: 'system:audit:operation:list',
            meta: { title: '操作日志列表' },
          },
          {
            id: 20_503,
            pid: 204,
            name: 'SystemAuditOperationDetail',
            status: 1,
            type: 'button',
            authCode: 'system:audit:operation:detail',
            meta: { title: '操作日志详情' },
          },
        ],
      },
